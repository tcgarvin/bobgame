...
This module is the single Python source of truth for the numeric floor codes.
They are a wire format: saved maps store them in a uint8 array and the viewer
repeats them in `viewer/src/terrain/TerrainConfig.ts`, which
`tests/test_terrain_types.py` checks against this table.
"""
